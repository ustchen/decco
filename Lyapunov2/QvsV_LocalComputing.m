function [aveQ] = QvsV_LocalComputing(omega_n,omega_Nm,omega_NM1,vector_V)
...
[f_nstar,f_emstar,Ptxnstar,f_rstar,kappa,kappae,kappar,Q,T,G,A]=LocalComputing(vector_V(v),omega_n,omega_Nm);
% size(f_nstar)   6  9000
