...
function [aveE,Q]=Sum_power_V_NRC(omega_n,omega_Nm,omega_NM1,vector_V)
...
[f_nstar,f_emstar,Ptxnstar,f_rstar,kappa,kappae,kappar,Q,T,G,A]=NoremoteCloud(vector_V(v),omega_n,omega_Nm);
% size(f_nstar)   6  9000
...
t_max=size(f_nstar,2);
    for t=1:t_max
        ...
        E(t,1)=E(t,1)+temp_omeganEnl+temp_omegaNmEme;
    end
