function [ ] = Plot_QvsV_LocalComputing()
...
QE4=0;
 figure(1)
 for iter=1:itermax
% [QE1]=QvsV_LocalComputing(1,0.1,0.1,vector_V); 
% QE1=QE1+QE1;
% [QE2]=QvsV_LocalComputing(1,0.5,0.5,vector_V);
% QE2=QE2+QE2;
% [QE3]=QvsV_LocalComputing(1,0.5,0.1,vector_V);
% QE3=QE3+QE3;
[QE4temp(iter)]=QvsV_LocalComputing(1,0.1,0.5,vector_V);
...
ylabel('Average system delay (ms)');
 legend('Local Computing $w_N=1, w_{N+m}=0.1, w_{N+M+1}=0.5$');
